    ...
    <div className="min-h-screen flex items-center justify-center bg-[#030712] relative overflow-hidden font-sans">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-black text-gradient font-display">Welcome Back</h2>
        ...
        <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center px-1">
                ...
                <a href="#" className="text-[10px] font-bold text-indigo-400 hover:text-indigo-300">Forgot?</a>
              </div>
              <div className="relative group">
          ...
          <button
            type="submit"
            className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl text-sm font-bold shadow-xl shadow-indigo-600/20 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest"><span className="bg-[#0f172a] px-3 text-slate-600 font-bold">Or continue with</span></div>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-500 font-medium">
          New to TaskFlow?{' '}
          <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-bold underline underline-offset-4 decoration-2 decoration-indigo-500/30 hover:decoration-indigo-500 transition-all">
            Create an account
          </Link>
        </p>
      </motion.div>
